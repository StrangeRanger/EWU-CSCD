...
public abstract class GameCharacter {
    ...
    public void playGuitar() { guitarType.guitar(); }

    /** Calls to 'soloAct' to print out the appropriate solo act. */
    public void playSolo() { soloActBehavior.soloAct(); }
     ...
     */
    public void setSolo(SoloActBehavior sab) { soloActBehavior = sab; }
     ...
     */
    public void setGuitar(GuitarType gt) { guitarType = gt; }
}
