    ...
    public static void main(String[] args) {
        ...
        while (userScore < scoreToWin && computerScore < scoreToWin) {
            ...
            if (userChoice >= 3 || userChoice < 0) { // Prevents input of >= 3 and < 0
                System.out.printf(
                    "%sInvalid input: Enter a number between 0 " + "and 2%s\n",
                    RED,
                    DEFCLR
                );
            ...
            if (hex.length() >= 1 && hex.length() <= 5) {
                ...
                for (var index = 0; index < hex.length(); index++) {
                    ...
                    if (
                        ...
                        invalidHex = true;
                        System.out.printf(
                            "%sInvalid hexadecimal: Enter a valid" +
                ...
                System.out.printf(
                    "%sInvalid input: Enter a total of 1 " +
        ...
        for (int i = 0; i < 5; i++) {
            ...
            while (true) {
                try {
                    ...
                    if (normalNumber < 0) {
                        System.out.printf(
                            "%sInvalid input: Negative numbers are" +
