...
public class HomeWorkFour {
    public static void main(String[] args) {
        ...
        System.out.println("\nChampion: " + ((userScore > computerScore)
                ? "User\n" : "Computer\n"));
        ...
        System.out.println("\n\n**********************\n* Performing Task 2! *\n" +
                "**********************");
        System.out.println("You'll be asked 5 times to enter 1 to 20 different integers " +
        ...
        while (validHex < 5) {
            ...
            if (hex.length() >= 1 && hex.length() <= 5) {
                ...
                for (var index = 0; index < hex.length(); index++) {
                    ...
                    if (Character.isLowerCase(hexIndex)) { hexIndex = Character.toUpperCase(hexIndex); }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            while (true) {
                try {
                    ...
                    System.out.printf("%sError: An exception occurred\nMake sure " +
        ...
        // Adds extra line between next task
        System.out.println("");
        System.out.println("In response to: (State briefly how your program treats " +
