...
public class HomeWorkThree {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            while (true) {
                ...
                if (year < 1900 || year > 2100) {
                    ...
                    System.out.printf(
                        "%sInvalid year: Enter a year between 1900 " +
                        "and 2100%s\n",
                        "\033[1;31m",
                        "\033[0m"
                    );
            ...
            while (true) {
                ...
                switch (month) {
                    case "jan":
                        System.out.println(
                            "There are 31 days in January of " + year + "\n"
                        );
                        break;
                    case "feb":
                        int day;
                    ...
                    case "mar":
                        System.out.println(
                            "There are 31 days in March of " + year + "\n"
                        );
                        break;
                    case "apr":
                        System.out.println(
                            "There are 30 days in April of " + year + "\n"
                        );
                        break;
                    case "may":
                        System.out.println(
                            "There are 31 days in May of " + year + "\n"
                        );
                        break;
                    case "jun":
                        System.out.println(
                            "There are 30 days in June of " + year + "\n"
                        );
                        break;
                    case "jul":
                        System.out.println(
                            "There are 31 days in July of " + year + "\n"
                        );
                        break;
                    case "aug":
                        System.out.println(
                            "There are 31 days in August of " + year + "\n"
                        );
                        break;
                    case "sep":
                        System.out.println(
                            "There are 30 days in September of " + year + "\n"
                        );
                        break;
                    case "oct":
                        System.out.println(
                            "There are 31 days in October of " + year + "\n"
                        );
                        break;
                    case "nov":
                        System.out.println(
                            "There are 30 days in November of " + year + "\n"
                        );
                        break;
                    case "dec":
                        System.out.println(
                            "There are 31 days in December of " + year + "\n"
                        );
                        break;
                    default:
                        // Output is printed in red
        ...
        for (int i = 0; i < 5; i++) {
            ...
            System.out.printf(
                "Cities in ascending order: %s < %s < %s\n\n",
                city1,
                city2,
                city3
            );
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int index = 0; index < normalString.length(); index++) {
                letter =
                    normalString.charAt(normalString.length() - (index + 1));
