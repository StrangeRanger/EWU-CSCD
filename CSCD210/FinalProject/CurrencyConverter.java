    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (conversionRates.get(base) != null) { // B. Null produced if base not found
                ...
                System.out.printf(
                    "%sInvalid input: Enter a valid base " + "currency%s\n",
                    RED,
                    DEFCLR
                );
            }
        ...
        while (true) {
            System.out.print(
                "Enter currency to convert the base currency to: "
            );
            ...
            if (conversionRates.get(nonBase) != null) { // B.
                ...
                System.out.printf(
                    "%sInvalid input: Enter a valid " + "currency%s\n",
                    RED,
                    DEFCLR
                );
            }
        ...
        while (true) {
            try {
                ...
                System.out.printf(
                    "%sInvalid input: Only numbers are " +
                    "accepted as input%s\n",
                    RED,
                    DEFCLR
                );
        ...
        System.out.printf(
            "Note: Output rounded to two decimals\nConverted " +
            "currency approximate: %s %s",
            df.format(amount * nonBaseValue),
            nonBase
        );
    }
