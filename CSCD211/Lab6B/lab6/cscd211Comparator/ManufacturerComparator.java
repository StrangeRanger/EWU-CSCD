...
// Class:       CSCD 211
// Description: This class represents a manufacturer sort which is a comparator
//              sort for the Engine class This class ensures the parameters to
//              the compare method are of both type Engine.
//
// *****************************************************************************
 ...
 * Engine class This class ensures the parameters to the compare method are of
 * both type Engine.
 */
public class ManufacturerComparator implements Comparator<Engine> {
     ...
     * simply compares the 2 engine manufacturers for order
     *
