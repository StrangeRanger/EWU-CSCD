...
public class SearchUtils<T extends Comparable<? super T>> {
    /**
     * The linearSearch method is passed an array of type guaranteed to have implemented
     * Comparable utilizing the generic and a target fo the same type. The methods
     * starts at index 0 and goes to the end of the array checking the element against
    ...
    public static <T extends Comparable<? super T>> int linearSearch(final   T[] array,
        ...
        for (int x = 0; x < array.length; x++) {
            if (array[x].equals(target)) { return x; }
        }
