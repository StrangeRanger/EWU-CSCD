...
/**
 * The SalaryComparator class the only compares by the Employee salary. The class
 * ensures an Employee is compared. All preconditions will be met and all parameters are
 * final.
 */
